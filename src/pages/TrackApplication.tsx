      ...
      <div className="max-w-4xl mx-auto">
        {config.enable_track_application === 0 ? (
          <div className="text-center py-20 bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] border border-slate-800">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Tracking Disabled</h1>
          ...
          <>
            <div className="text-center mb-12">
              <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">Track Your Application</h1>
              <p className="text-slate-400">Enter your Reference Number or Registered Mobile Number to check status.</p>
            </div>

            <div className="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] p-8 lg:p-12 border border-slate-800 shadow-2xl mb-12">
              <form onSubmit={handleTrack} className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-950 border border-slate-800 rounded-2xl text-white focus:border-blue-500 outline-none transition-all"
                    required
                  />
                </div>
                <ModernButton 
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] p-8 border border-slate-800 shadow-2xl">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-8 border-b border-slate-800">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-white">{application.reference_number}</div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-white font-semibold capitalize">{application.service_type}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-white font-semibold">{application.staff_name || 'Not assigned yet'}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8">
                  ...
                  <div className="bg-slate-900/50 backdrop-blur-xl rounded-[2.5rem] p-8 border border-slate-800 shadow-2xl">
                    <h3 className="text-xl font-bold text-white mb-8 flex items-center gap-2">
                      <Activity size={20} className="text-blue-400" /> Status Timeline
                    </h3>
                    <div className="space-y-8 relative before:absolute before:left-[17px] before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-800">
                      {application.updates.map((update: any, idx: number) => (
                        <div key={update.id} className="relative pl-12">
                          <div className={`absolute left-0 top-1 w-9 h-9 rounded-full border-4 border-slate-900 flex items-center justify-center z-10 ${idx === application.updates.length - 1 ? 'bg-blue-500 text-white' : 'bg-slate-800 text-slate-400'}`}>
